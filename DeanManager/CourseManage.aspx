<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourseManage.aspx.cs" Inherits="DeanManager_CourseManage" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        //add 2014-04-17
//        function fileManage_Click(s,e) {
//            //cl_btnFileManage.SetText("saffs");
//            //alert(e.visibleIndex);
//            //lblFile.SetText(cl_gvCourseInfo.visibleIndex);
//            //cl_popupFile.Show();
//        }
                    ...
                    <td>
                        ...
                        <div>
                            <dx:ASPxGridView ID="gvCourseInfo" runat="server" Width="100%" AutoGenerateColumns="False"
                                ...
                                Theme="Glass" oncustombuttoncallback="gvCourseInfo_CustomButtonCallback">
	...
	cl_popupFile.Show();
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewCommandColumn ShowSelectCheckbox="false" VisibleIndex="0" 
                                        Caption="附件" ButtonType="Link">
                                    <CustomButtons>
                                    <dx:GridViewCommandColumnCustomButton ID="fileManage" Text="附件">
                                                ...
                                                <tr>
                                                    <td>
                                                        <dx:ASPxButton ID="btnEditCourse" runat="server" CausesValidation="False" Text="修改"
                                                            ToolTip="修改当前课程信息" Width="50px" ClientSideEvents-Click='<%# "function(s, e) {cl_gvCourseInfo.StartEditRow(" + Container.VisibleIndex + ");e.processOnServer = false;}" %>'>
                                                        </dx:ASPxButton>
                                                    </td>
                                                   <%-- <td>
                                                        <dx:ASPxButton ID="btnFileManage" runat="server" CausesValidation="False" CommandArgument='<%# Eval("课程代码") %>'
                                                            ...
                                                            OnCommand="btnFileManage_Command" AutoPostBack="False" ClientInstanceName="cl_btnFileManage">
                                <ClientSideEvents Click="function(s,e){ alert(cl_gvCourseInfo.visibleIndex);}" />
                                                        </dx:ASPxButton>
                                                    </td>--%>
                                                    <td>
                                                        <dx:ASPxButton ID="btnDeleteCourse" runat="server" CausesValidation="False" Text="删除"
                                                            ToolTip="删除该门课程" Width="50px" ClientSideEvents-Click='<%# "function(s, e) {delConfirm(" + Container.VisibleIndex + ");e.processOnServer = false;}" %>'>
                                                        </dx:ASPxButton>
                                                       <%-- <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="ASPxLabel">
                                                            <ClientSideEvents Click="kcidGet" />
                                                        </dx:ASPxLabel>--%>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <dx:GridViewDataTextColumn VisibleIndex="1" FieldName="课程代码" ReadOnly="True" 
                                        Settings-AllowSort="True">
                                        <Settings AllowSort="True" />
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn VisibleIndex="2" FieldName="开课学院名称" Visible="True" 
                                        Caption="开课学院">
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataComboBoxColumn FieldName="课程性质" VisibleIndex="6">
                                        <PropertiesComboBox DataSourceID="odsCourseProperty" TextField="代码含义" ValueField="代码ID">
                                        </PropertiesComboBox>
                                        <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                                    </dx:GridViewDataComboBoxColumn>
                                    <dx:GridViewDataComboBoxColumn FieldName="课程类别" VisibleIndex="4">
                                        <PropertiesComboBox DataSourceID="odsCourseType" TextField="代码含义" ValueField="代码ID">
                                        </PropertiesComboBox>
                                        <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                                    </dx:GridViewDataComboBoxColumn>
                                    <dx:GridViewDataCheckColumn FieldName="双学位课程" VisibleIndex="15">
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="总学时" VisibleIndex="11">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="讲授学时" VisibleIndex="12">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="实践学时" VisibleIndex="13">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="精品课程网址" VisibleIndex="18">
                                        <DataItemTemplate>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="开课学院" VisibleIndex="24" Visible="False">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataComboBoxColumn FieldName="开课学期" VisibleIndex="10">
                                        <PropertiesComboBox DataSourceID="odsOpenTerm" TextField="代码含义" ValueField="代码ID">
                                        </PropertiesComboBox>
                                        <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                                    </dx:GridViewDataComboBoxColumn>
                                    <dx:GridViewDataTextColumn FieldName="先修课程" VisibleIndex="25" Visible="False">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="使用教材" VisibleIndex="26" Visible="False">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataCheckColumn FieldName="精品视频公开课" VisibleIndex="16">
                                        <PropertiesCheckEdit DisplayTextChecked="是" DisplayTextUnchecked="否" ValueChecked="1"
                                            ValueType="System.Int32" ValueUnchecked="0">
                                        </PropertiesCheckEdit>
                                        <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="后续课程" VisibleIndex="27" Visible="False">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="课程学分" VisibleIndex="3">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataComboBoxColumn FieldName="考核方式" VisibleIndex="8">
                                        <PropertiesComboBox DataSourceID="odsTestType" TextField="代码含义" ValueField="代码ID">
                                        </PropertiesComboBox>
                                        <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                                    </dx:GridViewDataComboBoxColumn>
                                    <dx:GridViewDataComboBoxColumn FieldName="教学方式" VisibleIndex="9">
                                        <PropertiesComboBox DataSourceID="odsTeachType" TextField="代码含义" ValueField="代码ID">
                                        </PropertiesComboBox>
                                        <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                                    </dx:GridViewDataComboBoxColumn>
                                    <dx:GridViewDataTextColumn FieldName="主要参考书目" VisibleIndex="28" Visible="False">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataCheckColumn FieldName="精品资源共享课" VisibleIndex="17">
                                        <PropertiesCheckEdit DisplayTextChecked="是" DisplayTextUnchecked="否" ValueChecked="1"
                                            ValueType="System.Int32" ValueUnchecked="0">
                                        </PropertiesCheckEdit>
                                        <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                                    </dx:GridViewDataCheckColumn>
                                    <dx:GridViewDataTextColumn FieldName="评分" VisibleIndex="29" Visible="False">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="已评分人数" VisibleIndex="30" Visible="False">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="实验学时" VisibleIndex="14">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="课程点击量" VisibleIndex="31" Visible="False">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataComboBoxColumn FieldName="课程级别" VisibleIndex="5">
                                        <PropertiesComboBox DataSourceID="odsCourseLevel" TextField="代码含义" ValueField="代码ID">
                                        </PropertiesComboBox>
                                        <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                                    </dx:GridViewDataComboBoxColumn>
                                    <dx:GridViewDataComboBoxColumn FieldName="面向对象" VisibleIndex="7">
                                        <PropertiesComboBox DataSourceID="odsCourseOO" TextField="代码含义" ValueField="代码ID">
                                        </PropertiesComboBox>
                                        <Settings AllowHeaderFilter="True" HeaderFilterMode="CheckedList" />
                                    </dx:GridViewDataComboBoxColumn>
                                    <dx:GridViewDataTextColumn FieldName="立项级别" Visible="False" VisibleIndex="20">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="立项年度" Visible="False" VisibleIndex="21">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="课程负责人" Visible="False" VisibleIndex="22">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="课程描述" Visible="False" VisibleIndex="23">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="课程图片" FieldName="课程图片" Visible="False" 
                                        VisibleIndex="19">
                                    </dx:GridViewDataTextColumn>
...
WdatePicker({dateFmt:'yyyy'});
	...
	setMajor(s,cl_ckbSelectMajor);
                            ...
                            <dx:ASPxCallback ID="fileCallBack" runat="server" 
                                ClientInstanceName="fileCallBack" oncallback="fileCallBack_Callback">
                                <ClientSideEvents CallbackComplete="function(s, e) {
	cl_uploadFile.UploadFile();
}" />
                            </dx:ASPxCallback>
                            <%--<dx:ASPxCallback ID="kcidCallBack" runat="server" 
                                ClientInstanceName="kcidCallBack" oncallback="kcidCallBack_Callback">
                                <ClientSideEvents CallbackComplete="function(s, e) {
	cl_popupFile.Show();
}" />
                            </dx:ASPxCallback>--%>
                            <dx:ASPxLabel ID="lblFile" runat="server" ClientInstanceName="lblFile" 
                                ForeColor="Red" Text="" Visible="true">
                            </dx:ASPxLabel>
                        </div>
                    </td>
                </tr>
            ...
            <dx:PopupControlContentControl runat="server" SupportsDisabledAttribute="True">
                <table class="dxflInternalEditorTable_Aqua" width="100%">
                    <tr>
                        ...
                        <td align="left" width="65%" valign="middle">
                            <dx:ASPxComboBox ID="cmbFileType" runat="server" EnableTheming="True" 
                                Theme="Aqua">
                                <Items>
                    ...
                    <tr>
                        ...
                        <%--<div id="upFile">--%>
                            <dx:ASPxUploadControl ID="uploadFile" runat="server" Theme="Aqua" UploadMode="Auto"
                                Width="280px" ShowProgressPanel="True" ShowUploadButton="True" 
                                ClientInstanceName="cl_uploadFile" 
                                OnFileUploadComplete="uploadFile_FileUploadComplete">
                                <ValidationSettings AllowedFileExtensions=".pdf">
                                </ValidationSettings>
                                <ClientSideEvents FileUploadStart="function(s, e) {
	fileCallBack.PerformCallback();
}" FileUploadComplete="function(s, e) {
	if(e.callbackData==&quot;success&quot;)
{
alert('附件上传成功!');
}
else if(e.callbackData==&quot;fail&quot;)
{
alert('附件上传失败!');
}
}" />
	...
	cl_popupFile.Hide();
                    ...
                    <tr>
                        <td align="right" width="50%">
                            <dx:ASPxLabel ID="lblType" runat="server" ClientInstanceName="cl_lblType" 
                                Visible="False">
                            </dx:ASPxLabel>
                        </td>
                        <td align="left">
