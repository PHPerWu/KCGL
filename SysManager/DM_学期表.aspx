<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DM_学期表.aspx.cs" Inherits="DM_学期表" %>
      ...
      <tr><td width="10%"></td><td width="80%" align="right">
            ...
            <tr>
                ...
                <td align="center" colspan="3">
                   <dx:ASPxGridView ID="gv_学期" runat="server" AutoGenerateColumns="False" 
                        DataSourceID="ObjectDataSource1" KeyFieldName="代码ID" Width="80%" 
                        oncustomerrortext="gv_学期_CustomErrorText" oninitnewrow="gv_学期_InitNewRow" >
                       <Columns>
                       ...
                       <SettingsText CommandCancel="[取消]" CommandEdit="[编辑]" CommandNew="[新增]" 
                           CommandUpdate="[确定]" Title="学期代码表" ConfirmDelete="确认删除吗？" />
                       <Styles>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                        ...
                        TypeName="DMDataSetTableAdapters.DM_学期表TableAdapter" 
                        UpdateMethod="Update">
                        <DeleteParameters>
