<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DM_获奖级别.aspx.cs" Inherits="SysManager_获奖级别" %>
                ...
                <td align="center" colspan="3">
                   <dx:ASPxGridView ID="gv_teach" runat="server" AutoGenerateColumns="False" 
                       ...
                       <SettingsText CommandCancel="[取消]" CommandEdit="[编辑]" CommandNew="[新增]" 
                           CommandUpdate="[确定]" Title="获奖级别代码表" ConfirmDelete="确认删除吗？" />
                       <Styles>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                        ...
                        TypeName="MainDataSetTableAdapters.DM_获奖级别TableAdapter" 
                        UpdateMethod="Update">
                        <DeleteParameters>
