<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DM_课程性质表.aspx.cs" Inherits="DM_课程性质表" %>
        ...
        <tr><td width="10%"></td><td width="80%" align="right">
            ...
            <tr>
                <td align="center" colspan="3">
                   <dx:ASPxGridView ID="gv_课程性质" runat="server" AutoGenerateColumns="False" 
                        DataSourceID="ObjectDataSource1" KeyFieldName="代码ID" Width="80%" 
                        oncustomerrortext="gv_课程性质_CustomErrorText" oninitnewrow="gv_课程性质_InitNewRow" >
                       <Columns>
                       ...
                       <SettingsText CommandCancel="[取消]" CommandEdit="[编辑]" CommandNew="[新增]" 
                           CommandUpdate="[确定]" Title="课程性质代码表" ConfirmDelete="确认删除吗？" />
                       <Styles>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                        ...
                        TypeName="DMDataSetTableAdapters.DM_课程性质表TableAdapter" 
                        UpdateMethod="Update">
                        <DeleteParameters>
