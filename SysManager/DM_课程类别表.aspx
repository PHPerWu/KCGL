<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DM_课程类别表.aspx.cs" Inherits="DM_课程类别表" %>
            ...
            <tr>
                <td align="center" colspan="3">
                   <dx:ASPxGridView ID="gv_teach" runat="server" AutoGenerateColumns="False" 
                        ...
                        oncustomerrortext="gv_teach_CustomErrorText" 
                        oninitnewrow="gv_teach_InitNewRow" >
                       <Columns>
                           ...
                           <dx:GridViewDataTextColumn FieldName="代码含义" 
                               VisibleIndex="2">
                           ...
                           <dx:GridViewDataCheckColumn FieldName="启用标志" VisibleIndex="3">
                           <PropertiesCheckEdit ValueChecked="true" ValueType="System.String" 
                                   ValueUnchecked="false">
                               </PropertiesCheckEdit>
                           </dx:GridViewDataCheckColumn>
                           <dx:GridViewDataMemoColumn FieldName="备注" VisibleIndex="4">
                           <PropertiesMemoEdit>
                                   <ValidationSettings>
                       ...
                       <SettingsText CommandCancel="[取消]" CommandEdit="[编辑]" CommandNew="[新增]" 
                           CommandUpdate="[确定]" Title="课程类别代码表" ConfirmDelete="确认删除吗？" />
                       <Styles>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                        ...
                        TypeName="DMDataSetTableAdapters.DM_课程类别表TableAdapter" 
                        UpdateMethod="Update">
                        <DeleteParameters>
