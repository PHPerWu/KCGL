<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DM_课程级别表.aspx.cs" Inherits="DM_课程级别表" %>
                ...
                <td align="center" colspan="3">
                   <dx:ASPxGridView ID="gv_teach" runat="server" AutoGenerateColumns="False" 
                       ...
                       <SettingsText CommandCancel="[取消]" CommandEdit="[编辑]" CommandNew="[新增]" 
                           CommandUpdate="[确定]" Title="课程级别代码表" ConfirmDelete="确认删除吗？" />
                       <Styles>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                        ...
                        TypeName="DMDataSetTableAdapters.DM_课程级别表TableAdapter" 
                        UpdateMethod="Update">
                        <DeleteParameters>
