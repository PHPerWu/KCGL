<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DM_面向对象表.aspx.cs" Inherits="DM_面向对象表" %>
    ...
    <table style="width: 100%;">
            ...
            <tr>  
                <td align="center" colspan="3">
                   <dx:ASPxGridView ID="gv_面向对象表" runat="server" AutoGenerateColumns="False" 
                        DataSourceID="ObjectDataSource1" KeyFieldName="代码ID" Width="80%" 
                        oncustomerrortext="gv_面向对象表_CustomErrorText" 
                        oninitnewrow="gv_面向对象表_InitNewRow" >
                       <Columns>
                       ...
                       <SettingsText CommandCancel="[取消]" CommandEdit="[编辑]" CommandNew="[新增]" 
                           CommandUpdate="[确定]" Title="面向对象代码表" ConfirmDelete="确认删除吗？" />
                       <Styles>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
                        ...
                        TypeName="DMDataSetTableAdapters.DM_面向对象表TableAdapter" 
                        UpdateMethod="Update">
                        <DeleteParameters>
